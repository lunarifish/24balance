...
#define YAW_SPEED_PID_MAX_OUT   11000.0f
#define YAW_SPEED_PID_MAX_IOUT  300.0f

//pitch gyro angle close-loop PID params, max out and max iout
//pitch �ǶȻ� �Ƕ��������ǽ��� PID�����Լ� PID���������������
#define PITCH_GYRO_ABSOLUTE_PID_KP 70.0f
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD 9.0f
...
#define YAW_GYRO_ABSOLUTE_PID_KP        74.0f
#define YAW_GYRO_ABSOLUTE_PID_KI        0.0f
#define YAW_GYRO_ABSOLUTE_PID_KD        9.0f
...
//yaw,pitch����ͨ���Լ�״̬����ͨ��
#define YAW_CHANNEL   2         // LEFT STICK L/R
#define PITCH_CHANNEL 3         // LEFT STICK F/B
#define GIMBAL_MODE_CHANNEL 0   // RIGHT SWITCH
