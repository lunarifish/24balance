...
void CAN_cmd_chassis_rc(int16_t move, int16_t rotate, int16_t reserve, int8_t sw) {
    uint32_t send_mail_box;
    chassis_tx_message.StdId = CAN_BOARD_COMM_ID;
    chassis_tx_message.IDE = CAN_ID_STD;
    chassis_tx_message.RTR = CAN_RTR_DATA;
    chassis_tx_message.DLC = 0x08;
    chassis_can_send_data[0] = move >> 8;
    chassis_can_send_data[1] = move;
    chassis_can_send_data[2] = rotate >> 8;
    chassis_can_send_data[3] = rotate;
    chassis_can_send_data[4] = reserve >> 8;
    chassis_can_send_data[5] = reserve;
    chassis_can_send_data[6] = sw;
    chassis_can_send_data[7] = 0;
